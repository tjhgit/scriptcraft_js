...
function lavaball(info) {
      var name2 = (examples_magic_wands.item_in_hand((info.getPlayer())));
        if (name2 == 'Lavaball Wand') {
                var loc = ((me).getLocation());
                    var dir = (loc.getDirection());
                        (((me).getType()).getWorld().spawnFallingBlock(((me).getType()), (Material.LAVA), 0)).setVelocity(((new org.bukkit.util.Vector(((dir.getX()) * 2), ((dir.getY()) * 2), ((dir.getZ()) * 2)))));
                          }
}
