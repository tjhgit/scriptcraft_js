...
function getPlayersBukkit(){
  ...
  //var players_collection = server.getOnlinePlayers();
  //var players = players_collection.toArray(new org.bukkit.entity.Player[players_collection.size()]);
  var players = server.getOnlinePlayers();
  //for (var i = 0; i < players.size(); i++){
  //  result.push(players.get(i));
  //}
  //result.push(players[0]);
  // I HAD TO CORRECT THIS CODE since size() does not exist
